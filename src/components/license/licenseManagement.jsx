  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div
            className={`flex items-center gap-2 rounded-lg px-4 py-3 shadow-lg ${getToastStyles(type)}`}
          >
            {getToastIcon(type)}
...
const LicenseManagement = ({ expirationDate, isActive }) => {
  ...
  useEffect(() => {
    const calculateLicenseStatus = () => {
      ...
      if (daysRemaining < 0) {
        ...
        timeRemaining =
          hoursRemaining > 0 ? `${hoursRemaining} hours` : 'Expires today'
  ...
  const handleRenewLicense = async () => {
    window.location.href =
      'mailto:team1.interns@botivate.in?subject=License Renewal&body=Please help me renew my license.'
  }
      ...
      <div className="mx-auto max-w-4xl">
        ...
        >
          ...
          <p className="text-gray-600">
            Manage your SalonMate software license and subscription
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-6 rounded-xl border border-gray-100 bg-white p-8 shadow-lg"
        >
          {/* Status Header */}
          <div className="mb-6 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className={`rounded-full p-3 ${licenseStatus.statusBg}`}>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-red-600">
                      Please renew your license to continue using SalonMate
                      features.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-yellow-600">
                      Your license will expire in {licenseStatus.timeRemaining}.
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
              ...
              className={`flex flex-1 items-center justify-center gap-2 rounded-lg px-6 py-3 font-medium transition-all duration-200 ${
                isRenewDisabled()
                  ...
                  : licenseStatus.status === 'Expired'
                    ...
                    : licenseStatus.status === 'Expiring Soon'
                      ? 'bg-yellow-600 text-white shadow-lg hover:bg-yellow-700 hover:shadow-xl'
            ...
            <motion.a
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              href="tel:99933023243"
              className="flex-1 rounded-lg border border-gray-300 px-6 py-3 font-medium text-gray-700 transition-colors hover:bg-gray-50 sm:flex-none"
            >
              Contact Support
            </motion.a>
          </div>
          ...
          {isRenewDisabled() && licenseStatus.status === 'Active' && (
            ...
            >
              <p className="text-sm text-blue-700">
                <strong>Note:</strong> License renewal is available 30 days
                before expiration.
              </p>
            </motion.div>
          )}
